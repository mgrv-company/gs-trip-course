...
const COPY_GROUPS = [
  ...
  ['팝업 · 가게 피드백', [
    ...
    ['fb.desc', '설명', 'textarea', '좋았어요·아쉬웠어요·문 닫았더라고요 — 뭐든 좋아요. 남겨주신 의견은 커뮤니티 매니저에게 바로 전달돼요. 30초면 충분해요!'],
  ...
  ['상황 안내 한 줄 (추천 카드 위 · 해당하는 때만 뜸, 비우면 안 뜸)', [
    ['note.morning', '아침 (6~10시)', 'input', '아침 일찍 여는 곳만 골라서 보여드릴게요.'],
    ['note.evening', '저녁 (17~20시)', 'input', '고성은 저녁 7시부터 문 닫는 곳이 빠르게 늘어요. 마감 시간을 확인하고 나서시길 추천해요.'],
    ['note.late', '밤 (20시 이후)', 'input', '지금 문 연 곳이 얼마 남지 않았어요. 포장·배달도 함께 살펴보세요.'],
    ['note.closedday', '화·수요일 (낮 시간대)', 'input', '오늘은 쉬는 가게가 많은 날이에요. 지금 문 연 곳만 골라서 보여드릴게요.'],
  ]],
  ['팝업 · 좋았던 곳 추천', [
